...
class SettingsPanel(ctk.CTkFrame):
    ...
    def _update_modified_indicator(self):
        ...
        if self._saved_preset_settings:
            ...
            # Detection batch is a hidden hardware-derived runtime value, not a
            # user-editable preset value.
    ...
    def set_total_vram_bytes(self, total_vram_bytes: int | None) -> None:
        """Update the telemetry used for hidden hardware-derived defaults."""
        self._total_vram_bytes = (
