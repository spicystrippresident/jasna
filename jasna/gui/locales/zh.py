...
ZH = {
        ...
        "job_processing": "处理中",
        "job_phase_preparing": "准备中",
        "job_phase_coarse_scan": "粗扫中",
        "job_phase_fine_scan": "精扫中",
        "job_phase_source_copy": "源视频复制中",
        "job_phase_restoring": "修复中",
        "job_phase_finalizing": "成片整理中",
        "stage_eta": "阶段 ETA: {eta}",
        "job_completed": "已完成",
        "completed_in": "完成用时",
        "job_error": "错误",
        "job_paused": "已暂停",
        ...
        "pre_scan_policy": "处理前扫描",
        "pre_scan_policy_auto": "自动（推荐）",
        "pre_scan_policy_scan": "始终扫描",
        "pre_scan_policy_off": "不单独扫描",
