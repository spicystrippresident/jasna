...
JA = {
        ...
        "job_processing": "処理中",
        "job_phase_preparing": "準備中",
        "job_phase_coarse_scan": "粗スキャン中",
        "job_phase_fine_scan": "精密スキャン中",
        "job_phase_source_copy": "元動画をコピー中",
        "job_phase_restoring": "復元中",
        "job_phase_finalizing": "仕上げ中",
        "stage_eta": "段階 ETA: {eta}",
        "job_completed": "完了",
        "completed_in": "完了時間",
        "job_error": "エラー",
        "job_paused": "一時停止",
        ...
        "pre_scan_policy": "処理前スキャン",
        "pre_scan_policy_auto": "自動（推奨）",
        "pre_scan_policy_scan": "常にスキャン",
        "pre_scan_policy_off": "個別スキャンなし",
        ...
        "save_run_log": "診断実行ログを保存",
        "run_log_path": "診断実行ログ: {path}",
        "run_log_unavailable": "診断実行ログを保存できませんでした。処理は続行します。",
        "denoise_none": "なし",
        "denoise_low": "低",
        "denoise_medium": "中",
        "denoise_high": "高",
        ...
        "tip_save_run_log": "このバッチのベストエフォート診断ログを書き込みます。出力フォルダーを選択した場合は .jasna-logs、入力と同じ場所を使う場合は Jasna 設定ディレクトリの run-logs に保存されます。キュー入力、処理メッセージ、定期的な Linux ホスト/GPU テレメトリーを含みます。ログ記録によって処理内容は変わりません。\n\nデフォルト：オフ",
        ...
        "tip_pre_scan_policy": "修復前に行うスキャン方法を指定します。自動では設定した粗スキャン間隔で調べ、全編処理か精密スキャンかを選びます。常にスキャンでは設定した精密スキャン間隔で調べ、モザイクのない区間をスキップします。個別スキャンなしでは別スキャンを行わず動画全体を処理します。スキャンはディスク上のチェックポイントから自動的に再開できます。",
