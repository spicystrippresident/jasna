...
JA = {
        ...
        "one_click_scan_threshold": "ワンクリックスキャンしきい値",
        "tip_one_click_scan_threshold": "事前スキャンと区間計画のみに使用され、フレームごとの復元しきい値は変更しません。rfdetr-v6 の既定値は 0.70 です。",
        "one_click_confirmation": "連続検出の確認",
        "tip_one_click_confirmation": "隣接するスキャンサンプルの連続検出を要求し、単発の誤検出を除外します。短いモザイクには 1 を使用します。",
        "one_click_confirmation_one": "1 回（高感度）",
        "one_click_confirmation_two": "2 回（推奨）",
        "one_click_confirmation_three": "3 回（厳格）",
        "section_basic": "基本設定",
