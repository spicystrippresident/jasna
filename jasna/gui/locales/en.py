...
EN = {
        ...
        "one_click_scan_threshold": "One-click scan threshold",
        "tip_one_click_scan_threshold": "Used only to pre-scan and plan ranges; it does not change frame-by-frame restoration confidence. rfdetr-v6 defaults to 0.70 and combines it with consecutive confirmation.",
        "one_click_confirmation": "Consecutive confirmation",
        "tip_one_click_confirmation": "Require adjacent scan samples to reach the scan threshold, filtering isolated false positives. Use 1 for very brief mosaics.",
        "one_click_confirmation_one": "1 hit (sensitive)",
        "one_click_confirmation_two": "2 hits (recommended)",
        "one_click_confirmation_three": "3 hits (strict)",
        ...
        "save_run_log": "Save diagnostic run log",
        "run_log_path": "Diagnostic run log: {path}",
        "run_log_unavailable": "Could not save the diagnostic run log. Processing will continue.",
        "denoise_none": "None",
        "denoise_low": "Low",
        ...
        "tip_save_run_log": "Writes a best-effort diagnostic log for this batch. With an output folder it is saved in .jasna-logs; with Same as input it is saved in Jasna's config run-logs folder. The log includes queued inputs, processing messages, and periodic Linux host/GPU telemetry. Logging never changes processing.\n\nDefault: Off",
