...
KO = {
        ...
        "job_processing": "처리 중",
        "job_phase_preparing": "준비 중",
        "job_phase_coarse_scan": "대략 스캔 중",
        "job_phase_fine_scan": "정밀 스캔 중",
        "job_phase_source_copy": "원본 복사 중",
        "job_phase_restoring": "복원 중",
        "job_phase_finalizing": "마무리 중",
        "stage_eta": "단계 ETA: {eta}",
        "job_completed": "완료",
        "completed_in": "소요 시간",
        "job_error": "오류",
        "job_paused": "일시 정지",
        ...
        "pre_scan_policy": "처리 전 스캔",
        "pre_scan_policy_auto": "자동 (권장)",
        "pre_scan_policy_scan": "항상 스캔",
        "pre_scan_policy_off": "별도 스캔 안 함",
        ...
        "save_run_log": "진단 실행 로그 저장",
        "run_log_path": "진단 실행 로그: {path}",
        "run_log_unavailable": "진단 실행 로그를 저장할 수 없습니다. 처리는 계속됩니다.",
        "denoise_none": "없음",
        "denoise_low": "낮음",
        "denoise_medium": "중간",
        "denoise_high": "높음",
        ...
        "tip_save_run_log": "이 배치의 최선형 진단 로그를 작성합니다. 출력 폴더를 선택하면 .jasna-logs에, 입력과 같은 위치를 사용하면 Jasna 설정 디렉터리의 run-logs에 저장됩니다. 대기열 입력, 처리 메시지, 주기적인 Linux 호스트/GPU 원격 측정을 포함합니다. 로그 기록은 처리 동작을 바꾸지 않습니다.\n\n기본값: 끔",
