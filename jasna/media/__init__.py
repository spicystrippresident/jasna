...
# while hevc_amf accepts the dotted level text below. Keep the explicit mapping
# so an unknown or malformed value cannot become an unsupported AMF argument.
...
AMF_SUPPORTED_ENCODER_SETTINGS_BY_CODEC: dict[str, frozenset[str]] = {
    ...
    "h264": _COMMON_AMF_ENCODER_SETTINGS | {"coder", "vbaq", "bf_ref"},
